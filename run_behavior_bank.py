...
def main() -> None:
    ...
    report = [
        ...
        f"- Delta available in source: {'yes' if 'delta' in candles else 'no'}",
        f"- Pressure available in source: {'yes' if 'pressure' in candles else 'no'}",
        f"- Liquidity score available in source: {'yes' if 'liquidity_score' in candles else 'no'}",
        "",
